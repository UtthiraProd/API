...
const PUMarriageProfileSchema = mongoose.Schema({
...
PUMarriageProfileSchema.virtual('age').get(function () {
...
module.exports = mongoose.model('PublicUserMarriageProfile', PUMarriageProfileSchema)